...
new DrawingApp();
var character_array = ['我', '学', '中', '文'];
character_array.forEach(function (character) {
    var unassigned = document.getElementById('characterList');
    ...
    unassigned === null || unassigned === void 0 ? void 0 : unassigned.appendChild(characters);
});
var button = document.getElementById('select');
var imagediv = document.getElementById('imagediv') || undefined;
var collection = document.getElementById('characterList');
button === null || button === void 0 ? void 0 : button.addEventListener('click', function () {
    var i = collection === null || collection === void 0 ? void 0 : collection.selectedIndex;
    if (imagediv !== undefined) {
        var image = document.createElement('img');
        image.setAttribute('src', (imagediv.innerHTML = collection.options[i].text + '.png'));
        var imgDiv = document.getElementById('imagediv');
        imgDiv === null || imgDiv === void 0 ? void 0 : imgDiv.appendChild(image);
    }
});
